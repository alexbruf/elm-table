...
| `ColumnResizeMode` | [`ColumnResizeMode`](/reference/module/Table#ColumnResizeMode) | [`resizeOnChange`](/reference/module/Table#resizeOnChange) and [`resizeOnEnd`](/reference/module/Table#resizeOnEnd). `Config.columnResizeMode` defaults to `resizeOnEnd`, as in TanStack. |
